...
document.querySelector<HTMLElement>('#controls-hint-content')!.innerHTML = isMobileDevice
  ...
  : '<span><i class="mouse left"></i>Click to Select or Place</span><span><i class="mouse left"></i>Drag Towers or Pan</span><span><i class="mouse right"></i>Remove Tower</span><span><i class="mouse key">R</i>Remove all Towers</span><span><i class="mouse middle"></i>Pan Camera</span><span><i class="mouse wheel"></i>Zoom</span>';
