...
document.querySelector<HTMLElement>('#controls-hint-content')!.innerHTML = isMobileDevice
  ? '<span><i class="mouse left"></i>Tap to Select or Place</span><span><i class="mouse left"></i>Tap Tower, then Tap Map to Move</span><span><i class="mouse left"></i>Drag a Selected Tower to Aim</span><span><i class="mouse key">X</i>Delete mode removes towers on tap</span><span><i class="mouse key">Q</i>Tap Ability, then Tap Target</span><span><i class="mouse wheel"></i>Pinch to Zoom</span>'
