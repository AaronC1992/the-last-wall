...
export const TOWER_CONFIG: readonly TowerConfigEntry[] = [
  ...
  { kind: 'fireTower', name: 'Fire Tower', hotkey: '3', cost: 80, limit: 4, color: '#c4713c', accent: '#f7b268', unlock: 'fireTower', glyph: 'F' },
  { kind: 'lightningTower', name: 'Lightning Tower', hotkey: '4', cost: 110, limit: 2, color: '#6f8fc4', accent: '#b3d4ff', unlock: 'lightningTower', glyph: 'L' },
