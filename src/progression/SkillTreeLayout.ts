...
const PLACEMENTS: readonly Placement[] = [
  ...
  { id: 'ballistaDiscount', branch: 'ballista', angle: -52, ring: 5.0, parent: 'ballistaRange' },
  ...
  { id: 'cannonDiscount', branch: 'cannon', angle: 220, ring: 6.5, parent: 'cannonRange' },
  ...
  { id: 'fireDiscount', branch: 'fire', angle: -4, ring: 6.5, parent: 'fireRange' },
  ...
  { id: 'mortarDiscount', branch: 'mortar', angle: 132, ring: 7.2, parent: 'mortarRange' },
  ...
  { id: 'teslaDiscount', branch: 'tesla', angle: 38, ring: 8.2, parent: 'teslaRange' },
  ...
  { id: 'sniperDiscount', branch: 'sniper', angle: -80, ring: 8.2, parent: 'sniperRange' },
];
